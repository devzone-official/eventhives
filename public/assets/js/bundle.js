...
},{"./emptyFunction":115,"_process":1}],"AddVendorForm":[function(require,module,exports){
var React = window.React ? window.React : require('react');

var AddVendorForm = React.createClass({displayName: "AddVendorForm",
  getInitialState: function(){
      ...
      React.createElement("div", {className: "content-wrapper"}, 
                    React.createElement("section", {className: "content-header"}, 
                      ...
                      React.createElement("ol", {className: "breadcrumb"}, 
                        React.createElement("li", null, React.createElement("a", {href: "/admin"}, React.createElement("i", {className: "fa fa-dashboard"}), " Home")), 
                        React.createElement("li", {className: "active"}, "Add Vendor")
                      )
                    ), 
                    React.createElement("section", {className: "content"}, 
                      React.createElement("div", {className: "box box-primary"}, 
                        React.createElement("div", {className: "box-header with-border"}, 
                          React.createElement("h3", {className: "box-title"}, "Provide the details of Vendor")
                        ), 

                        React.createElement("div", {role: "form"}, 
                          React.createElement("div", {className: "box-body"}, 
                            React.createElement("div", {className: "form-group"}, 
                              React.createElement("label", {htmlfor: "vendor_name"}, "Vendor Name"), 
                              React.createElement("input", {name: "name", onChange: (e) => this.handleNameChange(e), value: this.state.value, type: "text", className: "form-control", id: "vendor_name", placeholder: "Enter Vendor Name"})
                            ), 
                            React.createElement("div", {className: "checkbox"}, 
                              React.createElement("label", null, 
                                React.createElement("input", {name: "services[]", value: "venue provider", type: "checkbox", onChange: (e) => this.handleServiceChange(e)}), " Venue Provider"
                              )
                            ), 
                            React.createElement("div", {className: "checkbox"}, 
                              React.createElement("label", null, 
                                React.createElement("input", {name: "services[]", value: "caterer", type: "checkbox", onChange: (e) => this.handleServiceChange(e)}), " Caterer"
                              )
                            ), 
                            React.createElement("div", {className: "checkbox"}, 
                              React.createElement("label", null, 
                                React.createElement("input", {name: "services[]", value: "decorator", type: "checkbox", onChange: (e) => this.handleServiceChange(e)}), " Decorator"
                              )
                            ), 
                            React.createElement("div", {className: "checkbox"}, 
                              React.createElement("label", null, 
                                React.createElement("input", {name: "services[]", value: "digital service provider", type: "checkbox", onChange: (e) => this.handleServiceChange(e)}), " Digital Service Provider"
                              )
                            )
                          ), 

                          React.createElement("div", {className: "box-footer"}, 
                            React.createElement("button", {onClick: (e) => this.handleClick(e), className: "btn btn-primary"}, "Submit")
                          )
                        )
                      )
                    )
...
},{"react":"react"}],"MyReactClass":[function(require,module,exports){
var React = window.React ? window.React : require('react');
  ...
  render: function() {
    return (
      React.createElement("div", null, 
        "I am rendered with Reactdfk. I have a property: ", this.props.someAttribute
      )
    );
  }
});
...
},{"./lib/React":29}],"xhpjs":[function(require,module,exports){
/**
