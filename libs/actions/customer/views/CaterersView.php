<?hh
class :CaterersView extends :x:element{
  attribute
    Data data @required;
        ...
        <div class="row">
          ...
          <div class="col-md-5">
            <ul class="breadcrumb">
              ...
              <li><a href="shop-category.html">Caterers</a>
              </li>
              <li>Demo Caterers</li>
            </ul>
          </div>
                    ...
                    <form>
                      <div class="form-group">
                        <div class="text-center">
                          <h3><label for="count">NUMBER OF GUESTS</label></h3>
                          <input class="form-control" type="number" title="Count" id="count" value="100" name="count" min="100" max="650"  />
                        </div>
                      </div>
                      <p class="text-center">
                        <a class="btn btn-template-primary" data-toggle="modal" data-target="#menu-modal"><i class="fa fa-th-list"></i> Create Menu</a>
                      </p>
                      <div class="modal fade" id="menu-modal" tabindex="-1" role="dialog" aria-labelledby="Init" aria-hidden="true">
                      ...
                      <div class="price">&#8377;12400.00 <del> &#8377;15339.00</del> <p>per head</p></div>
                      <p class="text-center">
