<?hh
class :PhotographyIndexView extends :x:element{
  attribute
    Data data @required;
  protected function render(): \XHPRoot{
    ...
    $offset = 6 * ($page - 1);
    $limit = 6;
    $query = "SELECT * FROM photography LIMIT $limit OFFSET $offset";
    ...
    $description = "photography description goes on here  .. ";
                      ...
                      <ul class="nav nav-pills nav-stacked category-menu">
                        <li>
                          <ul>
                            ...
                            <li><a href="shop-category.html">Reception</a>
                            </li>
                            <li><a href="shop-category.html">Get-together</a>
                            </li>
          ...
          <div class="col-sm-9">
            ...
            <div class="row products">
              <div class="col-md-4 col-sm-6">
                <div class="product">
                  <div class="image">
                    <a href={"/services/photography?unit=".$block[0]["id"]}>
                      <img src="/assets/img/product1.jpg" alt="" class="img-responsive image1" />
                    </a>
                  </div>
                  <div class="text">
                    <h3><a href={"/services/photography?unit=".$block[0]["id"]}>{$block[0]["name"]}</a></h3>
                    <p class="price">{"$ ".$block[0]["cost"]}</p>
                    <p class="buttons">
                      <a href={"/services/photography?unit=".$block[0]["id"]} class="btn btn-default">View detail</a>
              ...
              <div class="col-md-4 col-sm-6">
                <div class="product">
                  <div class="image">
                    <a href={"/services/photography?unit=".$block[1]["id"]}>
                      <img src="/assets/img/product1.jpg" alt="" class="img-responsive image1" />
                    </a>
                  </div>
                  <div class="text">
                    <h3><a href={"/services/photography?unit=".$block[1]["id"]}>{$block[1]["name"]}</a></h3>
